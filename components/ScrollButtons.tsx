...
export default function ScrollButtons() {
  ...
  return (
    <div className="hidden xl:flex flex-col fixed right-8 top-[calc(50%+var(--header-height)/2)] transform -translate-y-1/2 z-20">
      <button
        className="p-2 mb-4 bg-white rounded-full shadow-md hover:bg-gray-100 text-gray-600"
      ...
      <button
        className="p-2 bg-white rounded-full shadow-md hover:bg-gray-100 text-gray-600"
